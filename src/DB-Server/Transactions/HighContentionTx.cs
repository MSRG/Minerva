...
{
    public new WriteSet WS = new();
    public new ReadSet RS = new();
    ...
    private void Put<TKey, TValue>(IDictionary<TKey, TValue> writeSet, TKey key)
    {
    ...
    {
        Put<(int, string), string>(WS.KVWriteSet, (shard, key));
    }
    ...
    public override void PutCustomer(Customer customer)
    {
        ...
        Put(WS.CustomerWriteSet, key);
    }

    public override void PutItem(Item item)
    {
        Put(WS.ItemWriteSet, item.I_ID);
    }

    public override void PutWarehouse(Warehouse warehouse)
    {
        Put(WS.WarehouseWriteSet, warehouse.W_ID);
    }
