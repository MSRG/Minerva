...
{    
    ...
    public (bool IsFeasible, List<int> Vertices, double SolveTime) Solve(StableSolverGraph graph, int solverType = 1)
    {
        CheckNotDisposed();
        ...
        solved = true;
        return (_result.IsFeasible == 1, vertices, _result.SolveTime);
    }
